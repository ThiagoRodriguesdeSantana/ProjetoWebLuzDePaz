	...
	<div class="container">
		<form method="POST" action="ClienteController"  onsubmit="return validaFormulario()">
			...
			<div class="form-group col-md-12">
				...
				<input type="email" class="form-control" id="email" placeholder="email" name="email"  value="<c:out value="${cliente.email}"/>">
			</div>

			<div class="form-group col-md-3">
				<label for="cpf">CPF</label> 
				<input type="text" class="form-control"id="cpf" placeholder="cpf" name="cpf" value="<c:out value="${cliente.cpf}"/>">
			</div>

			<div class="form-group col-md-3">
				<label for="telefone">Telefone</label> 
				<input type="text"class="form-control" id="telefone" placeholder="telefone" name="telefone"  value="<c:out value="${cliente.telefone}"/>">
			</div>

			<div class="form-group col-md-3">
				<label>Tipo de Usuário</label> 
				<select class="form-control" name="tipoCliente" value="<c:out value="${cliente.tipoCliente}"/>">
